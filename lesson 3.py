...
from data_mining.database.database import Database
    ...
    def parse_post(self, url, soup):
        ...
        data = {
            "post_data": {
                ...
                "picture": soup.find("article", attrs={"class": "blogpost__article-wrapper"})
                               .find("img")['src'],
                "date": soup.find("time", attrs={"class": "text-muted"})['datetime']
            },
            "author_data": {
...
if __name__ == "__main__":
    database = Database("sqlite:///D:\\Geekbrains\\Методы сбора и обработки данных из сети Интернет\\data_mining\\gb_blog.db")
